            ...
            <div class="table-responsive m-b-10">
               ...
               <thead><th>Name</th><th>Description</th><th>Price</th><th>Teacher</th><th>Image</th><th>Actions</th></thead>
                  <tbodey>
                     ...
                     <tr>
                         <td>{{$oetItem->oet_course_name}}</td>
                         <td>{{$oetItem->oet_course_description}}</td>
                         <td>{{$oetItem->oet_course_price}}</td>
                         <td>{{$oetItem->oet_course_teacher_name}}</td>
                      <td><img src="{{ asset('storage/'.$oetItem->image) }}"></td>
                      <td>
                        <form action="index_oet/{{$oetItem->id}}/delete">
                          <button class="btn btn-danger float-right btn-sm">Delete</button>
                        </form>
                         <form action="index_oet/{{$oetItem->id}}/edit_oet_course">
